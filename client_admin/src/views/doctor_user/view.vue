			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="医生性别" prop="doctors_gender">
					...
					<div v-else-if="$check_field('get','doctors_gender')">{{form_sub['doctors_gender']}}</div>
								...
								<el-col v-if="user_group === '管理员' || $check_field('get','professional_title_of_doctor') || $check_field('add','professional_title_of_doctor') || $check_field('set','professional_title_of_doctor')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="医生职称" prop="professional_title_of_doctor">
												<el-input id="professional_title_of_doctor" v-model="form_sub['professional_title_of_doctor']" placeholder="请输入医生职称"
							  v-if="user_group === '管理员' || (form_sub['doctor_user_id'] && $check_field('set','professional_title_of_doctor')) || (!form_sub['doctor_user_id'] && $check_field('add','professional_title_of_doctor'))"></el-input>
					<div v-else-if="$check_field('get','professional_title_of_doctor')">{{form_sub['professional_title_of_doctor']}}</div>
											</el-form-item>
			</el-col>
			...
			return {
				...
				disabledObj:{
								"doctors_name_isDisabled": false,
										...
										"professional_title_of_doctor_isDisabled": false,
							},

				form_sub: {
								"doctors_name":  '', // 医生姓名
										"doctors_gender":  '', // 医生性别
										"professional_title_of_doctor":  '', // 医生职称
									    "user_id": 0,
					"doctor_user_id": 0 // ID
				},
