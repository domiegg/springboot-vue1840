...
const routes = [
	...
	// 抗癌分类路由
	{
		path: '/anticancer_classification/table',
		name: 'anticancer_classification_table',
		component: () => import('../views/anticancer_classification/table.vue'),
		meta: {
			index: 0,
			title: '抗癌分类列表'
		}
	...
	{
		path: '/anticancer_classification/view',
		name: 'anticancer_classification_view',
		component: () => import('../views/anticancer_classification/view.vue'),
		meta: {
			index: 0,
			title: '抗癌分类详情'
		}
	...
	// 抗癌方法路由
	{
		path: '/anticancer_methods/table',
		name: 'anticancer_methods_table',
		component: () => import('../views/anticancer_methods/table.vue'),
		meta: {
			index: 0,
			title: '抗癌方法列表'
		}
	...
	{
		path: '/anticancer_methods/view',
		name: 'anticancer_methods_view',
		component: () => import('../views/anticancer_methods/view.vue'),
		meta: {
			index: 0,
			title: '抗癌方法详情'
		}
	...
	// 医生点评路由
	{
		path: '/doctors_comments/table',
		name: 'doctors_comments_table',
		component: () => import('../views/doctors_comments/table.vue'),
		meta: {
			index: 0,
			title: '医生点评列表'
		}
	...
	{
		path: '/doctors_comments/view',
		name: 'doctors_comments_view',
		component: () => import('../views/doctors_comments/view.vue'),
		meta: {
			index: 0,
			title: '医生点评详情'
		}
