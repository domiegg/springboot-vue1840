<template>
	<div class="diy_details_box diy_div_anticancer_methods">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/anticancer_methods/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/anticancer_methods/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var anticancer_methods_id = this.obj.anticancer_methods_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "anticancer_methods",
          source_field: "anticancer_methods_id",
          source_id: anticancer_methods_id
        }, (res) => {
